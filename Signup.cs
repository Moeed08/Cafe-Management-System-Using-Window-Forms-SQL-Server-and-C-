    ...
    public partial class Signup : Form
    {
        ...
        private void textBox3_TextChanged(object sender, EventArgs e)
        {
           ...
           /* // Validate the email format using a regular expression
            ...
            {
                // Valid email format
                //labelStatus.Text = "Email is valid";
            ...
            else
            {
                ...
                // Invalid email format
                    MessageBox.Show("Invalid email format", "Validation Result", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }*/
        ...
        {
             string ConnectionString = "Data Source=Moeedspc\\SQLEXPRESS;Initial Catalog=CafeSystem;Integrated Security=True";
